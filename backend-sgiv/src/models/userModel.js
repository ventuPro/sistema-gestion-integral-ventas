...
// Listar todos los usuarios con rol, sucursal y estado de caja
...
const actualizarUsuario = async (id_usuario, datos) => {
    ...
    const result = await db.query(
        `UPDATE usuario SET nombre_completo=$1, correo_electronico=$2, id_rol=$3, id_sucursal=$4
         WHERE id_usuario=$5 RETURNING id_usuario, nombre_completo, correo_electronico`,
